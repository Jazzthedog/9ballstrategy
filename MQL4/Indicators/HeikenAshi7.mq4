...
//---
input color ExtColor1 = DarkOrange;    // Shadow of bear candlestick
input color ExtColor2 = GreenYellow;  // Shadow of bull candlestick
input color ExtColor3 = DarkOrange;    // Bear candlestick body
input color ExtColor4 = GreenYellow;  // Bull candlestick body
//--- buffers
...
//--- indicator lines
   ...
   SetIndexStyle(2,DRAW_HISTOGRAM,0,8,ExtColor3);
   SetIndexBuffer(2,ExtOpenBuffer);
   SetIndexStyle(3,DRAW_HISTOGRAM,0,8,ExtColor4);
