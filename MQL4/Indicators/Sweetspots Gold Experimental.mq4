...
extern int  ShiftLabel =  200 ;
extern int  SizeLabel =  1 ;


extern int NumLinesAboveBelow  = 100;
extern int SweetSpotMainLevels = 10000;

extern color LineColorMain= White;
extern int LineStyleMain= STYLE_DOT;

extern bool ShowSubLevels= true;
extern int sublevels= 2500;
...
int init()
{
   ...
   if(AutoAdjust && period > PERIOD_H1 && period < PERIOD_W1) { mult = mult * 10; }
