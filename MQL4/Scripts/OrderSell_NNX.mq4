...
*/
   ...
   ticket1=OrderSend(Symbol(), OP_SELL, lotSize, Ask, iSlipage, Ask+(ATRPoints*InpSLfactor), Ask-(ATRPoints*InpTPfactor), sText, 192, 0, sArrow);
   if(ticket1<0)
   {
